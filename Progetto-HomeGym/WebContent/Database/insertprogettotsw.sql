...
insert into prodotto value("AAAA1","Technogym MyRun","Design essenziale e compatto, superficie di corsa adattiva, allenamenti personalizzati direttamente sul tuo tablet.","3200","22", "10","0","Fitness","1",".");
insert into prodotto value("BBBB2","Synchro Forma","Synchro Forma è il cross trainer professionale perfetto per godersi un allenamento total body in tutta semplicità. La fluidità di movimento riduce lo stress articolare e muscolare, rendendolo ideale per dimagrire, tonificare e migliorare la coordinazione.","3590","22","10","0","Fitness","1",".");
insert into prodotto value("CCCC3","Jump Rope","Jump Rope contribuisce ad aumentare il condizionamento metabolico e la coordinazione che costituiscono la base di velocità, agilità e rapidità. Le impugnature della corda sono zigrinate nella parte inferiore per migliorare la presa e presentano dei cuscinetti a sfera per una rotazione più efficiente durante l'allenamento.","50","69","22","0","Accessori","4",".");
insert into prodotto value("DDDD4","Exercise Mat","Lo spessore della schiuma e la superficie antiscivolo rendono Exercise Mat un comodo strumento per eseguire esercizi di stretching e di forza in maniera comoda e sicura direttamente sul pavimento, senza che il tappetino slitti, si pieghi o si sposti durante l'esercizio.","79","22","23","20","Accessori","4",".");
insert into prodotto value("EEEE5","Jog Forma","Jog Forma è un tapis roulant professionale che, grazie alla nuova interfaccia utente con guida all'allenamento tramite QR code e ai nuovi Hand Sensor, consente di allenarsi in modo semplice ed efficace. La pedana Long Life Deck, il telaio resistente e la potenza del motore garantiscono prestazioni di livello superiore.","6900","22","0","0","Fitness","1",".");
