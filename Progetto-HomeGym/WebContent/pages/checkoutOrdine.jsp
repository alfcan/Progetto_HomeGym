...
<html>
	...
	<body>
		...
		<%if(indirizziSpedizione.isEmpty() || datiPagamento.getNumeroCarta().equals("")){%>
			<h3>Inserisci i dati di pagamento e spedizione prima di procedere al checkout</h3>
			<p>Come fare? <a href="pages/areaUtente.jsp">Vai nell'area utente</a> nella sezione "Dati Pagamento & Spedizione"</p>
		<%} else {%>
